...
// For example, in the image below you can see that on the first iteration there is only
// a single dot, on the second iteration there are 6 dots, on the third there are 16 dots,
...
function PentagonalNumber(N) {
  ...
  if (N !== 1) {
    return PentagonalNumber(N - 1) + 5 * (N - 1);
  } else {
    return 1;
  }
